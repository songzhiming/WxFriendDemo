...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *navgation=[[UINavigationController alloc] initWithRootViewController:rootViewController];
    //    navgation.navigationBarHidden = YES;
    self.window.rootViewController=navgation;
    NSLog(@"height====%f",navgation.navigationBar.frame.size.height);
